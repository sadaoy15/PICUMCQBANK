...
const picumcqExamGroups: ExamGroup[] = [
  { id: "picumcq-book", label: "PICU MCQ Review", description: "Complete question set with explanations and figures (PICU MCQ Review)", accent: "indigo", match: (q) => q.category === "PICU MCQ Review" },
];
